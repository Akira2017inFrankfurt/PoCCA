...
from basic_encoders import PointNet_CLS_Encoder, DGCNN_CLS_Encoder
...
def get_model(device, checkpoint_path, rank, args): 
    ...
    model = SimAttention_Multi_X_Attn(
        online_encoder = online_encoder, 
        x_attn = CrossAttnBolck().cuda(), 
        patch_num_list = args.patch_num_list
        )
